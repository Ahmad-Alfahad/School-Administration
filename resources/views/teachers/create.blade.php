<x-app-layout>
    <x-slot name="header">
        <div class="py-2">
            ...
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">
                Add a new faculty member to the system and link them to their assigned classroom.
            </p>
        </div>
    </x-slot>
    ...
    <div class="py-8 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-4">
            <a href="{{ route('teachers.index') }}" class="inline-flex items-center gap-2 text-sm font-semibold text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-200 transition-colors">
